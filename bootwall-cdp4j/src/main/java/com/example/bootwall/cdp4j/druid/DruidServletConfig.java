package com.example.bootwall.cdp4j.druid;
...
public class DruidServletConfig {
  ...
  @Bean
  public ServletRegistrationBean<StatViewServlet> registrationBean(DruidServletValue druidServletValue) {
  ...
  @Bean
  public FilterRegistrationBean<WebStatFilter> filterRegistrationBean(DruidServletValue druidServletValue) {
