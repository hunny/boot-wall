...
public class BasicAuthentication {
  ...
  public static void main(String[] args) {
    ...
    try (SessionFactory factory = launcher.launch(); Session session = factory.create()) {
      ...
      network.setRequestInterception(Arrays.asList(pattern));
      ...
      session.addEventListener((e, v) -> {
        ...
        if (Events.NetworkRequestIntercepted.equals(e)) {
          ...
          if (ri.getAuthChallenge() != null) {
            ...
            network.continueInterceptedRequest(ri.getInterceptionId(), null, null, null, null, null,
                null, acr);
          } else {
